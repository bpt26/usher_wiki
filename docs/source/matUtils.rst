...
To install matUtils, simply follow the _`directions for installing UShER <https://usher-wiki.readthedocs.io/en/latest/UShER.html#installation>`_, and matUtils will be included in your installation.
