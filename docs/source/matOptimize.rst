...
To install matOptimize, simply follow the `directions for installing UShER <https://usher-wiki.readthedocs.io/en/latest/UShER.html>`_, and matOptimize will be included in your installation.
