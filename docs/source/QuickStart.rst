...
The full manual page including detailed parameter information can be found :doc:`here <matUtils>`. matUtils is installed with the UShER package (see above installation instructions using conda).
...
Tutorials for matUtils, including an example workflow, sample placement uncertainty, and phylogeographic analysis, can be found :doc:`here <tutorials>`.
...
The full manual page including detailed parameter information can be found :doc:`here <matOptimize>`. matOptimize is installed with the UShER package (see above installation instructions using conda).
...
RIPPLES is a program that can detect recombinant nodes and their ancestors in a mutation-annotated tree (MAT). The full manual page including detailed parameter information can be found :doc:`here <ripples>`. RIPPLES is installed with the UShER package (see above installation instructions using conda).
