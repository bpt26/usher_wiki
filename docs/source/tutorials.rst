...
of a variant of concern into our region that has led to a number of samples. 
Let's take a closer look by visualizing it on the `Auspice <https://auspice.us/>`_ web interface.
